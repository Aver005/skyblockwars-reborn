package ru.kiviuly.mcmgp.listener;
 ...
 * (не трогает остальные миры сервера). Игро-специфику решает сам {@link ru.kiviuly.mcmgp.game.Minigame}.
 */
public class ProtectionListener implements Listener
{
    private final McmgpPlugin plugin;

    public ProtectionListener(McmgpPlugin plugin) {this.plugin = plugin;}
