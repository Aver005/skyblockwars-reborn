 ...
 * в {@link McmgpPlugin#onEnable} (замени {@code new TemplateGame(this)}). Класс
...
{
    protected final McmgpPlugin plugin;

    protected Minigame(McmgpPlugin plugin) {this.plugin = plugin;}
