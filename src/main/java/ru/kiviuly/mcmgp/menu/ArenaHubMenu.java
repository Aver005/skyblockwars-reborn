...
/**
 * Хаб настройки арены (/mg gui &lt;ID&gt;): из него доступны параметры, точки, имя/
...
public class ArenaHubMenu extends Menu
{
    ...
    public ArenaHubMenu(McmgpPlugin plugin, Arena arena)
    {
    ...
    {
        p.closeInventory();
        p.performCommand("mg " + sub + " " + arena.getId());
    }
