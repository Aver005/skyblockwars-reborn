...
import ru.kiviuly.mcmgp.game.GamePhase;
 ...
 * стандартные (арена/фаза/игроки/время) плюс {@link ru.kiviuly.mcmgp.game.Minigame#scoreboardLines}.
...
public class GameScoreboard
{
    ...
    private void ensure(GameSession s)
    {
        ...
        objective = board.registerNewObjective("mcmgp", Criteria.DUMMY,
