package ru.kiviuly.skyblockwars.arena;
...
public class ArenaManager
{
    ...
    public ArenaManager(SkyBlockWarsPlugin plugin) {this.plugin = plugin;}
    ...
    /** Выход игрока по своей воле (/sbw leave или дисконнект). */
