package ru.kiviuly.skyblockwars.ui;
 ...
 * стандартные (арена/фаза/игроки/время) плюс {@link ru.kiviuly.skyblockwars.game.Minigame#scoreboardLines}.
...
public class GameScoreboard
{
    ...
    private void ensure(GameSession s)
    {
        ...
        objective = board.registerNewObjective("sbw", Criteria.DUMMY,
