package ru.kiviuly.skyblockwars.menu;
...
/**
 * Хаб настройки арены (/sbw gui &lt;ID&gt;): из него доступны параметры, точки, имя/
...
public class ArenaHubMenu extends Menu
{
    ...
    public ArenaHubMenu(SkyBlockWarsPlugin plugin, Arena arena)
    {
    ...
    {
        p.closeInventory();
        p.performCommand("sbw " + sub + " " + arena.getId());
    }
